 ...
 *
 *  @param asynView VVTextStorage所处的VVAsyncView
 ...
 *
 *  @param asynView VVImageStorage所处的VVAsyncView
 ...
 */
typedef void(^VVAsyncViewAutoLayoutCallback)(VVImageStorage *imageStorage, CGFloat delta);
